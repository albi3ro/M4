...
If you haven't read it already, checkout [Atomic Orbitals Pt. 1]({{base.url}}/M4/prerequisites/Atomic-Orbitals.html).  Today we try and make some prettier pictures.  GLVisualize is a quite beautiful package, but not entirely the easiest to use at this point with some not so consistent documentation.
